    ...
    <body>
        ...
        <form method="POST">
            <fieldset>
                ...
                <span class="error">${messages.buyProduct}</span>
            </fieldset>
        </form>
        <form method="POST">
            <fieldset>
                <legend>Ajouter du credit</legend>
                combien de credit a ajouter?: <input type="number" name="addCredit" required>
                <button type="submit" name="submit">Ajouter</button> 
                <span class="error">${messages.AddSelectedMoney}</span>
            </fieldset>
        </form>
